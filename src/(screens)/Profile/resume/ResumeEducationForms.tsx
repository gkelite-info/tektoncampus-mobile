...
export function ResumePrimaryEducationForm({ data, onSave, studentId }: SharedProps) {const { t } = useTranslation();
...
export function ResumeSecondaryEducationForm({ data, onSave, onDelete, studentId }: SharedProps) {const { t } = useTranslation();
...
export function ResumeUndergraduateEducationForm({ data, onSave, onDelete, studentId }: SharedProps) {const { t } = useTranslation();
...
export function ResumePhdEducationForm({ data, onSave, onDelete, studentId }: SharedProps) {const { t } = useTranslation();
...
export function ResumeMastersEducationForm({ data, onSave, onDelete, studentId, collegeId }: SharedProps) {const { t } = useTranslation();
  const [institutionName, setInstitutionName] = useState(data?.institutionName || "");
  const [courseName, setCourseName] = useState(data?.courseName || "");
  const [specialization, setSpecialization] = useState(data?.specialization || "");
