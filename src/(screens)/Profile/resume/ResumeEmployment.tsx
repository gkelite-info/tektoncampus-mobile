...
import {
  ...
  updateEmployment,
  deleteEmployment
} from "../../../lib/helpers/resume/employmentAPI";

function EmploymentFormItem({ item, studentId, onSaved, onDelete }: any) {
    ...
    return (
        <View className="border border-gray-200 rounded-xl p-4 bg-white mb-4 ">
            <Text className="text-sm font-medium text-[#282828] mb-1">Company Name *</Text>
            <TextInput
            ...
            <Text className="text-sm font-medium text-[#282828] mb-1">Designation *</Text>
            <TextInput
                className="border border-[#CCCCCC] rounded-md px-3 py-2 text-[#282828] mb-3"
            ...
            <View className="flex-row gap-3 mb-3">
                <View className="flex-1">
                    <Text className="text-sm font-medium text-[#282828] mb-1">Exp (Years)</Text>
                    <TextInput
                ...
                <View className="flex-1">
                    <Text className="text-sm font-medium text-[#282828] mb-1">Exp (Months)</Text>
                    <TextInput
                        className="border border-[#CCCCCC] rounded-md px-3 py-2 text-[#282828]"
                        keyboardType="numeric"
...
export default function ResumeEmployment() {
    ...
    if (isPageLoading) {
        return (
            <View className="flex-1 bg-white rounded-xl  items-center justify-center p-4">
                ...
                <Text className="text-gray-400 mt-2">Loading employment...</Text>
            </View>
        );
    }
        ...
        <ScrollView className="flex-1 bg-[#f6f7f9] p-4">
            <View className="bg-white rounded-lg p-6  mb-10">
                <View className="flex-row justify-between items-center mb-6">
                    <Text className="text-lg font-semibold text-[#000000]">Employment</Text>
                </View>
                ...
                >
                    <Text className="text-[#43C17A] font-bold">+ Add Employment</Text>
                </TouchableOpacity>
            </View>
        </ScrollView>
    );
