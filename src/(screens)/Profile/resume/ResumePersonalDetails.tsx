...
export default function ResumePersonalDetails({ onNext }: {onNext?: () => void;}) {const { t } = useTranslation();
  ...
  return (
    <ScrollView className="flex-1 bg-white rounded-xl " contentContainerStyle={{ padding: 16 }}>
            ...
            <Text className="text-red-500">*</Text>
                    ...
                    <TextInput
            className="border border-[#CCCCCC] rounded-md px-3 py-2 text-[#282828]"
            placeholder={t("Auto.Attr.EnterMobileNumb", "Enter Mobile Number")}
            value={mobile}
            ...
            <Text className="text-red-500">*</Text>
                    ...
                    <TextInput
            className="border border-[#CCCCCC] rounded-md px-3 py-2 text-[#282828]"
            placeholder={t("Auto.Attr.EnterEmailID", "Enter Email ID")}
            value={email}
