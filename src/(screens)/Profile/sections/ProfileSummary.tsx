...
import {
  ...
  updateProfileSummary } from
"@/lib/helpers/profile/profileProfileSummary";

export default function ProfileSummary() {const { t } = useTranslation();
  ...
  return (
    <View className="bg-white rounded-xl  p-6 mt-4">
            ...
            multiline
            maxLength={1000}
            placeholder={t("Auto.Attr.ApassionateComp", "A passionate Computer Science student with a strong interest in software development and problem-solving. Eager to apply technical skills to real-world projects and grow as a developer.")}
