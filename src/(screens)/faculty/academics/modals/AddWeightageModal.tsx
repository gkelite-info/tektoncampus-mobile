...
export default function AddWeightageModal({
  ...
  useEffect(() => {
    async function loadExistingWeightages() {
      ...
      try {
        setLoading(true);
        const configs = await fetchFacultyWeightageConfigs(subjectDetails.collegeSubjectId, subjectDetails.collegeSectionId, subjectDetails.collegeSemesterId);
  ...
  const handleSave = async () => {
    ...
    setIsSaving(true);
    try {
      const existingConfig = await fetchExistingFacultyWeightageConfig(subjectDetails.collegeSubjectId, subjectDetails.collegeSectionId, subjectDetails.collegeSemesterId);
