      ...
      <View className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <View className="mb-4">
            ...
            <View className="flex-row items-center gap-2 border border-gray-200 rounded-md p-2 bg-white flex-wrap">
                ...
                <View className="flex-1 min-w-[120px] bg-gray-50 rounded-md overflow-hidden h-8 justify-center">
                    ...
                    >
                        <Picker.Item label="Select section" value="" color="#9CA3AF" style={{fontSize: 12}} />
        ...
        <View className="flex-row gap-4 mb-4">
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Deadline <Text className="text-red-500">*</Text></Text>
          ...
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Marks <Text className="text-red-500">*</Text></Text>
            <TextInput
              value={form.marks}
        ...
        <View className="mt-2 mb-4">
            ...
            <TouchableOpacity onPress={handlePickFile} className="border-2 border-dashed border-gray-300 rounded-xl p-6 items-center justify-center bg-gray-50/50 mb-3">
                <Text className="text-gray-500 text-sm mb-2">Tap to upload files</Text>
            </TouchableOpacity>
        ...
        <View className="flex-row items-center justify-end mt-2 border-t border-gray-100 pt-4 gap-3">
          ...
          <TouchableOpacity onPress={handleSave} disabled={isSaving} className="px-8 py-2 rounded-md bg-[#43C17A]">
            {isSaving ? <ActivityIndicator size="small" color="white" /> : <Text className="text-white text-sm font-bold">Save</Text>}
          </TouchableOpacity>
        </View>
      </View>
      <View className="h-10" />
