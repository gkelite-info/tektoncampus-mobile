  ...
  return (
    <ScrollView className="flex-1 w-full" showsVerticalScrollIndicator={false}>
      ...
      <View className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <View className="mb-4">
          ...
          <View className="flex-row gap-3">
            <View className="flex-1">
              <Text className="mb-1 text-sm font-bold text-[#282828]">Year <Text className="text-red-500">*</Text></Text>
        ...
        {/* Description */}
        <View className="mb-4">
          <Text className="mb-1 text-sm font-bold text-[#282828]">Description <Text className="text-gray-400 font-normal">(optional)</Text></Text>
          <TextInput
        ...
        {/* File Section */}
        <View className="mb-4">
          <Text className="mb-2 text-sm font-bold text-[#282828]">Lab Manual PDF <Text className="text-red-500">*</Text></Text>
          ...
          {!pdfFile && !existingFileName ? (
            <TouchableOpacity onPress={handlePickFile} className="border-2 border-dashed border-gray-300 rounded-xl p-6 items-center justify-center bg-gray-50/50">
                <Text className="text-gray-500 text-sm font-bold mb-1">Upload PDF</Text>
                <Text className="text-gray-400 text-xs">Tap to browse files</Text>
            </TouchableOpacity>
          ) : (
