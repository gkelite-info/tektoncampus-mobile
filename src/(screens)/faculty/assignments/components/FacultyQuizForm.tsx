  ...
  return (
    <ScrollView className="flex-1 w-full" showsVerticalScrollIndicator={false}>
      ...
      <View className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        {/* Topic */}
        <View className="mb-4">
          <Text className="mb-1 text-sm font-bold text-[#282828]">Topic <Text className="text-red-500">*</Text></Text>
          <View className="border border-gray-200 rounded-md bg-white overflow-hidden">
            <Picker
            ...
            >
              <Picker.Item label="Select Topic" value="" color="#9CA3AF" />
        ...
        <View className="flex-row gap-4 mb-4">
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Academic Year <Text className="text-red-500">*</Text></Text>
            <View className="border border-gray-200 rounded-md bg-white overflow-hidden">
              <Picker
          ...
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Section <Text className="text-red-500">*</Text></Text>
            <View className="border border-gray-200 rounded-md bg-white overflow-hidden">
              <Picker
        ...
        <View className="bg-gray-50 p-3 rounded-lg mb-4 flex-row gap-4">
          <View className="flex-1">
            <Text className="mb-1 text-xs font-bold text-gray-500">No. Questions <Text className="text-red-500">*</Text></Text>
            <TextInput
          ...
          <View className="flex-1">
            <Text className="mb-1 text-xs font-bold text-gray-500">Marks/Qtn <Text className="text-red-500">*</Text></Text>
            <TextInput
          ...
          <View className="flex-1">
            <Text className="mb-1 text-xs font-bold text-gray-500">Total Marks</Text>
        ...
        <View className="flex-row gap-4 mb-4">
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Duration (Mins) <Text className="text-red-500">*</Text></Text>
            <TextInput
          ...
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Max Attempts</Text>
            <TextInput
        ...
        <View className="flex-row gap-4 mb-4">
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">Start Date <Text className="text-red-500">*</Text></Text>
          ...
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">End Date <Text className="text-red-500">*</Text></Text>
        ...
        <View className="flex-row gap-4 mb-6">
          ...
          <View className="flex-1">
            <Text className="mb-1 text-sm font-bold text-[#282828]">End Time <Text className="text-red-500">*</Text></Text>
        ...
        <View className="flex-row items-center justify-between mt-2 border-t border-gray-100 pt-4 gap-2">
          ...
          <TouchableOpacity onPress={() => handleSave('Draft')} disabled={isDraftSaving} className="px-2 py-3 rounded-md bg-[#16284F] flex-1 items-center">
            {isDraftSaving ? <ActivityIndicator size="small" color="white" /> : <Text className="text-white text-sm font-medium text-center">Save Draft</Text>}
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleSave('Active')} disabled={isSaving} className="px-2 py-3 rounded-md bg-[#43C17A] flex-1 items-center">
            {isSaving ? <ActivityIndicator size="small" color="white" /> : <Text className="text-white text-sm font-medium text-center">Save & Next</Text>}
          </TouchableOpacity>
        </View>
      </View>
      <View className="h-10" />
