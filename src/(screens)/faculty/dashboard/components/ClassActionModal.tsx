            ...
            <>
              <View className="px-5 py-4 space-y-4">
                <View className="space-y-1 mb-3">
                  <Text className="text-xs font-bold text-gray-500 mb-1 uppercase tracking-wider">Class Title</Text>
                ...
                <View className="space-y-1 mb-3">
                  <Text className="text-xs font-bold text-gray-500 mb-1 uppercase tracking-wider">Topic</Text>
                  <View className="w-full px-3 py-3 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <View className="space-y-1 mb-3">
                  <Text className="text-xs font-bold text-gray-500 mb-1 uppercase tracking-wider">Class Date</Text>
                  <View className="w-full px-3 py-3 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <View className="space-y-1 mb-3">
                  <Text className="text-xs font-bold text-gray-500 mb-1 uppercase tracking-wider">Class Time</Text>
                  <View className="flex-row items-center justify-between gap-3">
                    ...
                    <Text className="text-sm font-medium text-gray-400">to</Text>
                    <View className="flex-1 px-3 py-3 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <View className="space-y-1 mb-1">
                  <Text className="text-xs font-bold text-gray-500 mb-1 uppercase tracking-wider">Classroom</Text>
                  <View className="w-full px-3 py-3 border border-gray-200 rounded-lg bg-gray-50">
          ...
          {step === "confirm_accept" && (
            <>
              <View className="px-5 py-8 items-center">
                <Text className="text-gray-900 font-bold text-lg text-center mb-2">Are you sure you want to accept this class?</Text>
                <Text className="text-sm text-gray-500 text-center">This will officially mark the class as accepted and redirect to Attendance.</Text>
              </View>
              <View className="px-5 py-4 flex-row gap-3">
                <TouchableOpacity
                  onPress={async () => {
          ...
          {step === "cancel_reason" && (
            <>
              <View className="px-5 py-4">
                <Text className="text-xs font-bold text-gray-700 mb-2 uppercase tracking-wider">Reason for Cancellation</Text>
                <TextInput
                  value={reason}
              ...
              <View className="px-5 py-4 flex-row gap-3">
                ...
                >
                   {isProcessing ? (
                    ...
                    <Text className="text-white font-bold text-sm">Confirm Cancel</Text>
                  )}
                </TouchableOpacity>
                <TouchableOpacity
                  onPress={() => setStep("initial")}
