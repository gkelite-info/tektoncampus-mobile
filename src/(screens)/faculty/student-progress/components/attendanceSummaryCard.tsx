...
export default function AttendanceSummaryCard({
  ...
  return (
    <View style={tw`bg-white shadow-sm p-4 md:p-6 rounded-xl border border-gray-100 w-full h-full flex-col min-h-[300px]`}>
      <Text style={tw`text-[16px] md:text-lg font-bold text-[#333] mb-4 tracking-tight`}>
        Attendance Summary
      </Text>
      ...
      <View style={tw`flex-1 items-center justify-center`}>
        <View style={tw`items-center`}>
          ...
          <View style={tw`absolute bottom-120 items-center justify-end`}>
            ...
            <Text style={tw`text-xs md:text-sm font-bold text-[#888] mt-1 uppercase tracking-widest`}>
              Attendance
            </Text>
          </View>
        </View>
        ...
        <View style={tw`flex-row gap-6 md:gap-10 mt-6 md:mt-8`}>
          <View style={tw`flex-row items-center gap-2 md:gap-3`}>
            ...
            <Text style={tw`text-[13px] md:text-[15px] font-bold text-gray-600`}>
              Absent
            </Text>
          </View>
          <View style={tw`flex-row items-center gap-2 md:gap-3`}>
