...
export default function StudentProfileCard({
  ...
  absentPercentage,
  leavePercentage
}: ProfileProps) {const { t } = useTranslation();
  return (
      ...
      <View style={tw`mt-4 md:mt-8 flex-row justify-between mt-auto gap-2`}>
        <View style={tw`flex-1`}>
          <StatCard
            bg="bg-[#E8F5E9]"
            iconBg="bg-[#4CAF50]"
            title={t("Auto.Attr.TotalAttendance", "Total Attendance")}
        ...
        <View style={tw`flex-1`}>
          <StatCard
            bg="bg-[#FFEBEE]"
            iconBg="bg-[#F44336]"
            title={t("Auto.Attr.TotalAbsent", "Total Absent")}
        ...
        <View style={tw`flex-1`}>
          <StatCard
            bg="bg-[#E3F2FD]"
            iconBg="bg-[#42A5F5]"
            title={t("Auto.Attr.TotalLeave", "Total Leave")}
...
}: {bg: string;iconBg: string;title: string;value: string | number;}) {
  return (
