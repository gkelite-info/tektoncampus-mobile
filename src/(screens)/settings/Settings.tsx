...
export default function SettingsScreen() {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState(i18n.language === 'hi' ? 'Hindi' : i18n.language === 'te' ? 'Telugu' : 'English');
  useEffect(() => {
    if (!userId) return;
  ...
  const changeLanguage = (lang: string) => {
    ...
    if (lang === 'English') i18n.changeLanguage('en');else if (lang === 'Hindi') i18n.changeLanguage('hi');else if (lang === 'Telugu') i18n.changeLanguage('te');
