...
function AssignmentsLeftContent() {
    ...
    const activeView =
        (searchParams.view as "active" | "previous") || "active";
    const quizView =
        (searchParams.quizView as "ongoing" | "attempted") || "ongoing";
    const discussionView =
        (searchParams.discussionView as "active" | "completed") || "active";
    ...
    const [discussionSubTabLoading, setDiscussionSubTabLoading] =
        useState(false);
    const [assignmentSubTabLoading, setAssignmentSubTabLoading] =
        useState(false);
    ...
    return (
        <View className="w-full px-3 py-0 flex-1 bg-white" style={{ paddingTop: headerHeight + 16 }}>
            {activeModal === "performance" &&
                ...
                (performanceLoading ? (
                    ...
                    <QuizPerformanceModal
                        visible={activeModal === "performance"}
                        quiz={performanceData}
                        onClose={() => setParams({ modal: undefined, quizId: undefined, submissionId: undefined })}
                        onViewAnswers={() => {
                            setParams({ action: "viewAnswers", modal: undefined });
                        }}
                    />
                ) : null)}
            ...
            <View className="mb-2">
                <View className="mb-3 mt-0">
                    ...
                    <Text className="text-[#282828] text-base" style={{ fontFamily: fonts.regular }}>
                ...
                <ScrollView
                    ...
                    className="flex-row gap-5 border-b border-gray-200 mt-2 mb-2"
                    contentContainerStyle={{ alignItems: "center" }}
                >
                    <TouchableOpacity
                        onPress={() => handleTabChange("assignments")}
                        className={`mr-5 pb-2 border-b-2 ${activeTab === "assignments"
                            ? "border-[#43C17A]"
                            : "border-transparent"
                            }`}
                    >
                        <Text
                            className={`text-lg ${activeTab === "assignments"
                                ? "text-[#43C17A]"
                                : "text-gray-500"
                                }`}
                    ...
                    <TouchableOpacity
                        ...
                        className={`mr-5 pb-2 border-b-2 ${activeTab === "quiz" ? "border-[#43C17A]" : "border-transparent"
                            }`}
                    >
                        <Text
                            className={`text-lg ${activeTab === "quiz" ? "text-[#43C17A]" : "text-gray-500"
                                }`}
                            style={{ fontFamily: fonts.bold }}
                        >
                            {t("Quiz")}
                    ...
                    <TouchableOpacity
                        ...
                        className={`mr-5 pb-2 border-b-2 ${activeTab === "discussion"
                            ? "border-[#43C17A]"
                            : "border-transparent"
                            }`}
                    >
                        <Text
                            className={`text-lg ${activeTab === "discussion"
                                ? "text-[#43C17A]"
                                : "text-gray-500"
                                }`}
                            style={{ fontFamily: fonts.bold }}
                    ...
                    <TouchableOpacity
                        ...
                        className={`mr-5 pb-2 border-b-2 ${activeTab === "lab" ? "border-[#43C17A]" : "border-transparent"
                            }`}
                    >
                        <Text
                            className={`text-lg ${activeTab === "lab" ? "text-[#43C17A]" : "text-gray-500"
                                }`}
                            style={{ fontFamily: fonts.bold }}
                        >
                            Lab
            ...
            <View className="w-full flex-1">
                {activeTab !== "lab" && (
                    <View className="flex-row w-full border-b border-gray-200 mb-4 mt-0">
                        {activeTab === "assignments" && (
                            <>
                                <TouchableOpacity
                                    className={`flex-1 pb-2 items-center border-b-2 ${activeView === "active"
                                        ? "border-[#43C17A]"
                                        : "border-transparent"
                                        }`}
                                    onPress={() => handleViewChange("active")}
                                >
                                    <Text
                                        className={`text-base ${activeView === "active"
                                            ? "text-[#43C17A]"
                                            : "text-gray-500"
                                            }`}
                                ...
                                <TouchableOpacity
                                    className={`flex-1 pb-2 items-center border-b-2 ${activeView === "previous"
                                        ? "border-gray-800"
                                        : "border-transparent"
                                        }`}
                                    onPress={() => handleViewChange("previous")}
                                >
                                    <Text
                                        className={`text-base ${activeView === "previous"
                                            ? "text-gray-800"
                                            : "text-gray-500"
                                            }`}
                                        style={{ fontFamily: fonts.semiBold }}
                        ...
                        {activeTab === "quiz" && (
                            <>
                                <TouchableOpacity
                                    className={`flex-1 pb-2 items-center border-b-2 ${quizView === "ongoing"
                                        ? "border-[#43C17A]"
                                        : "border-transparent"
                                        }`}
                                    onPress={() => handleQuizViewChange("ongoing")}
                                >
                                    <Text
                                        className={`text-sm ${quizView === "ongoing"
                                            ? "text-[#43C17A]"
                                            : "text-gray-500"
                                            }`}
                                        style={{ fontFamily: fonts.bold }}
                                ...
                                <TouchableOpacity
                                    className={`flex-1 pb-2 items-center border-b-2 ${quizView === "attempted"
                                        ? "border-[#43C17A]"
                                        : "border-transparent"
                                        }`}
                                    onPress={() => handleQuizViewChange("attempted")}
                                >
                                    <Text
                                        className={`text-sm ${quizView === "attempted"
                                            ? "text-[#43C17A]"
                                            : "text-gray-500"
                                            }`}
                                        style={{ fontFamily: fonts.bold }}
                        ...
                        {activeTab === "discussion" && (
                            <>
                                <TouchableOpacity
                                    className={`flex-1 pb-2 items-center border-b-2 ${discussionView === "active"
                                        ? "border-[#43C17A]"
                                        : "border-transparent"
                                        }`}
                                    onPress={() => handleDiscussionViewChange("active")}
                                >
                                    <Text
                                        className={`text-sm ${discussionView === "active"
                                            ? "text-[#43C17A]"
                                            : "text-gray-500"
                                            }`}
                                        style={{ fontFamily: fonts.bold }}
                                ...
                                <TouchableOpacity
                                    className={`flex-1 pb-2 items-center border-b-2 ${discussionView === "completed"
                                        ? "border-gray-800"
                                        : "border-transparent"
                                        }`}
                                    onPress={() => handleDiscussionViewChange("completed")}
                                >
                                    <Text
                                        className={`text-sm ${discussionView === "completed"
                                            ? "text-gray-800"
                                            : "text-gray-500"
                                            }`}
                                        style={{ fontFamily: fonts.bold }}
                ...
                <ScrollView className="mt-2" contentContainerStyle={{ paddingBottom: 24 }}>
                    {activeTab === "assignments" &&
                            ...
                            <>
                                {activeView === "active" &&
                                    (activeAssignments.length > 0 ? (
                                        ...
                                        <Text className="text-sm text-gray-500 mt-4 text-center" style={{ fontFamily: fonts.regular }}>
                                ...
                                {activeView === "previous" &&
                                    (previousAssignments.length > 0 ? (
                                        <View className="text-sm text-[#282828]">
                                            <AssignmentCardMobile
                            ...
                            {quizView === "ongoing" && (
                                <View className="flex-col h-full">
                                    {quizzesLoading || quizSubTabLoading ? (
                                        ...
                                        <View className="items-center justify-center h-1/3 mt-10">
                                            <Text className="text-sm text-gray-500" style={{ fontFamily: fonts.regular }}>
                    ...
                    {activeTab === "discussion" && (
                        <View className="flex-col gap-4 pb-10 h-full">
                                            ...
                                            activeDiscussions
                                                ...
                                                .map((discussion) => (
                                                    <StudentDiscussionCard
                                                        ...
                                                        onRemoveFile={(studentDiscussionUploadId: any) => {
                    ...
                    {activeTab === "lab" && (
                        <View className="flex-col gap-4 pb-10 h-full mt-2">
                ...
                {activeTab === "assignments" && totalPages > 1 && (
                    <View className="flex-row justify-center items-center gap-2 mt-6 pb-6">
                        <TouchableOpacity
                            ...
                            className={`p-2 rounded-lg border bg-white ${currentPage === 1 ? "opacity-30" : ""
                                }`}
                        >
                        ...
                        <View className="flex-row gap-1">
                            {[...Array(totalPages)].map((_, i) => (
                                <TouchableOpacity
                                    ...
                                    className={`w-9 h-9 rounded-lg items-center justify-center ${currentPage === i + 1
                                        ? "bg-[#16284F]"
                                        : "bg-white border border-gray-300"
                                        }`}
                                >
                                    <Text
                                        className={`text-sm font-bold ${currentPage === i + 1 ? "text-white" : "text-gray-600"
                                            }`}
                                        style={{ fontFamily: fonts.bold }}
                                    >
                                        {i + 1}
                        ...
                        <TouchableOpacity
                            ...
                            className={`p-2 rounded-lg border bg-white ${currentPage === totalPages ? "opacity-30" : ""
                                }`}
                        >
                    ...
                    (() => {
                        const list =
                            discussionView === "active"
                                ? activeDiscussions
                                : completedDiscussions;
                        const discTotalPages = Math.ceil(
                            list.length / DISCUSSION_PER_PAGE,
                        );
                        return discTotalPages > 1 &&
                            ...
                            <View className="flex-row justify-center items-center gap-2 mt-6 pb-6">
                                <TouchableOpacity
                                    ...
                                    className={`p-2 rounded-lg border bg-white ${discussionCurrentPage === 1 ? "opacity-30" : ""
                                        }`}
                                >
                                    <CaretLeft size={18} weight="bold" color="black" />
                                </TouchableOpacity>
                                <View className="flex-row gap-1">
                                    {[...Array(discTotalPages)].map((_, i) => (
                                        <TouchableOpacity
                                            key={i + 1}
                                            onPress={() => setDiscussionCurrentPage(i + 1)}
                                            className={`w-9 h-9 rounded-lg items-center justify-center ${discussionCurrentPage === i + 1
                                                ? "bg-[#16284F]"
                                                : "bg-white border border-gray-300"
                                                }`}
                                        >
                                            <Text
                                                className={`text-sm font-bold ${discussionCurrentPage === i + 1
                                                    ? "text-white"
                                                    : "text-gray-600"
                                                    }`}
                                                style={{ fontFamily: fonts.bold }}
                                ...
                                <TouchableOpacity
                                    ...
                                    className={`p-2 rounded-lg border bg-white ${discussionCurrentPage === discTotalPages
                                        ? "opacity-30"
                                        : ""
                                        }`}
                                >
                ...
                {activeTab === "lab" &&
                    (() => {
                        ...
                        return labTotalPages > 1 && !labsLoading ? (
                            <View className="flex-row justify-center items-center gap-3 mt-6 mb-6">
                                <TouchableOpacity
                                    onPress={() => setLabCurrentPage((p) => Math.max(1, p - 1))}
                                    disabled={labCurrentPage === 1}
                                    className={`w-10 h-10 items-center justify-center rounded-lg border ${labCurrentPage === 1
                                        ? "border-gray-200"
                                        : "border-gray-300"
                                        }`}
                                >
                                    <CaretLeft
                                        size={18}
                                        weight="bold"
                                        color={labCurrentPage === 1 ? "#D1D5DB" : "#4B5563"}
                                    />
                                </TouchableOpacity>
                                ...
                                {[...Array(labTotalPages)].map((_, i) => (
                                    <TouchableOpacity
                                        key={i}
                                        onPress={() => setLabCurrentPage(i + 1)}
                                        className={`w-10 h-10 rounded-lg items-center justify-center ${labCurrentPage === i + 1
                                            ? "bg-[#16284F]"
                                            : "border border-gray-300"
                                            }`}
                                    >
                                        <Text
                                            className={`font-semibold ${labCurrentPage === i + 1
                                                ? "text-white"
                                                : "text-gray-600"
                                                }`}
                                            style={{ fontFamily: fonts.semiBold }}
                                ...
                                <TouchableOpacity
                                    ...
                                    className={`w-10 h-10 items-center justify-center rounded-lg border ${labCurrentPage === labTotalPages
                                        ? "border-gray-200"
                                        : "border-gray-300"
                                        }`}
                                >
                                    <CaretRight
                                        ...
                                        weight="bold"
                                        color={
                                            labCurrentPage === labTotalPages ? "#D1D5DB" : "#4B5563"
                                        }
                                    />
                                </TouchableOpacity>
                            </View>
