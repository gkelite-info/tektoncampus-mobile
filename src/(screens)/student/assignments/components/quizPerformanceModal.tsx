...
import { View, Modal, Image, ScrollView, TouchableOpacity } from 'react-native';
...
export default function QuizPerformanceModal({
  ...
  return <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
            <View className="flex-1 items-center justify-center bg-black/50 p-4">
                ...
                <View className="bg-white rounded-[24px] w-full flex-col overflow-hidden" style={{
        height: "80%"
      }}>
          ...
          paddingBottom: 24
                        ...
                        <View className="items-center justify-center my-4">
                            <View className="w-[180px] h-[180px] items-center justify-center relative">
                                <Image source={require("../../../../../assets/result-circle.png")} className="w-full h-full" resizeMode="contain" />

                                <View className="absolute items-center justify-center w-full">
                                    <Text className="text-3xl text-[#A17A08] text-center" style={{
                  fontFamily: fonts.bold
                }}>
                                        {quiz.score}
                                    </Text>
                                    <Text className="text-lg text-[#182142] mt-0.5" style={{
                  fontFamily: fonts.bold
                }}>
                                        {quiz.percentage}%
                                    </Text>
              ...
              fontFamily: fonts.regular
                ...
                fontFamily: fonts.bold
                    ...
                    <View className="px-6 py-5 border-t border-gray-100 flex-col gap-3 bg-white shrink-0">
                        {quiz.allAttemptsUsed ? <TouchableOpacity onPress={onViewAnswers} activeOpacity={0.8} className="w-full bg-[#16284F] py-3.5 rounded-xl items-center justify-center shadow-xs">
              ...
              fontFamily: fonts.bold
                        ...
                        <TouchableOpacity onPress={onClose} activeOpacity={0.7} className="w-full bg-white border border-gray-300 py-3.5 rounded-xl items-center justify-center">
