...
function TimetableRow({
    ...
    return <View className="flex-row items-center bg-white rounded-xl px-3 py-2.5 mb-2" style={{
        shadowColor: "#000",
        shadowOffset: {
            width: 0,
            height: 1
        ...
        <View className="flex-1">
            <Text className="text-[#282828] text-[13px]" numberOfLines={1} style={{ fontFamily: fonts.semiBold }}>
                {subject}
            </Text>
            {!!time && (
                <Text className="text-[#43C17A] text-[11px] mt-0.5" style={{ fontFamily: fonts.medium }}>
                    {time}
                </Text>
            )}
            {(!!faculty || !!room) && (
                <Text className="text-gray-400 text-[13px] mt-0.5" numberOfLines={1} style={{ fontFamily: fonts.regular }}>
...
function StatCard({
    ...
    return <View className="flex-1 rounded-2xl items-center justify-center py-4 mx-1" style={{
        backgroundColor: bg
    }}>
        ...
        <ScrollView className="flex-1" contentContainerStyle={{
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{
                ...
                {week.map((item, index) => {
                    ...
                    return <TouchableOpacity key={index} activeOpacity={0.8} onPress={() => setSelectedDate(item.fullDate)} className={`flex-col items-center justify-center h-16 w-16 rounded-xl mx-0.5 ${isActive ? "bg-[#43C17A]" : "bg-[#DCEAE2]"}`} style={isActive ? {
                        shadowColor: "#43C17A",
                        shadowOffset: {
                            width: 0,
                            height: 4
            ...
            {activeDayItem && <View className="bg-[#43C17A] rounded-2xl p-3 flex-row items-stretch gap-3 mt-3" style={{
                shadowColor: "#43C17A",
                shadowOffset: {
                    width: 0,
                    height: 4
            ...
            <View className="mt-5">
                <View className="flex-row items-center gap-3 mb-3">
                    <View className="bg-[#1E2A45] rounded-lg items-center justify-center px-3 py-1.5" style={{
                        minWidth: 48
                    }}>
