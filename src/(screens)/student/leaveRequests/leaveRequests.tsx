            ...
            >
                ...
                {showForm ? (
                    <View className="bg-white p-5 rounded-2xl shadow-md border border-slate-100 mb-6">
                        ...
                        <Text className="text-slate-500 text-xs mb-1.5" style={{ fontFamily: fonts.medium }}>Reason</Text>
                        <TextInput 
                        ...
                        <View className="flex-row justify-end" style={{ gap: 8 }}>
                            ...
                            >
                                <Text className="text-slate-600 text-xs font-semibold" style={{ fontFamily: fonts.medium }}>Cancel</Text>
                            </TouchableOpacity>
                            <TouchableOpacity 
                                onPress={() => setShowForm(false)}
                                className="px-4 py-2 bg-[#43C17A] rounded-xl"
                            >
                                <Text className="text-white text-xs font-bold" style={{ fontFamily: fonts.bold }}>Submit</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                ) : (
                    ...
                    >
                        <Text className="text-emerald-700 text-sm font-semibold" style={{ fontFamily: fonts.bold }}>
                            + Apply for Leave
                        </Text>
                    </TouchableOpacity>
                )}
