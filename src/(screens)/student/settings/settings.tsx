...
export default function SettingsScreen() {const { t } = useTranslation();
  ...
  return (
    <SafeAreaView edges={["left", "right", "bottom"]} className="flex-1 bg-[#F8FAFC]">
        ...
        showsVerticalScrollIndicator={false}>
                ...
                {}
                <View className="mb-6">
                    <Text className="text-2xl text-[#1E293B]" style={{ fontFamily: fonts.bold }}>{t("Auto.Common.AppSettings", "App Settings")}

          </Text>
                    <Text className="text-sm text-gray-500 mt-1" style={{ fontFamily: fonts.regular }}>{t("Auto.Common.Managenotificat", "Manage notification configurations and profile credentials")}
                ...
                <View className="bg-white p-5 rounded-2xl shadow-sm border border-slate-100 mb-6">
                    <Text className="text-[#1E293B] text-[15px] mb-4" style={{ fontFamily: fonts.bold }}>{t("Auto.Common.Notifications", "Notifications")}
                    ...
                    <View className="flex-row items-center justify-between py-2 border-b border-slate-50">
                        <View className="flex-row items-center flex-1 mr-3">
                            ...
                            <View className="ml-3">
                                <Text className="text-slate-700 text-xs font-semibold" style={{ fontFamily: fonts.medium }}>{t("Auto.Common.PushNotificatio", "Push Notifications")}

                </Text>
                                <Text className="text-slate-400 text-[9px] mt-0.5" style={{ fontFamily: fonts.regular }}>{t("Auto.Common.Alertsforclassa", "Alerts for class announcements & timetable updates")}
              ...
              thumbColor={pushNotifs ? "#10B981" : "#94A3B8"} />
                    ...
                    <View className="flex-row items-center justify-between py-2 mt-2">
                        <View className="flex-row items-center flex-1 mr-3">
                            <Bell size={18} color="#64748B" />
                            <View className="ml-3">
                                <Text className="text-slate-700 text-xs font-semibold" style={{ fontFamily: fonts.medium }}>{t("Auto.Common.EmailNotificati", "Email Notifications")}

                </Text>
                                <Text className="text-slate-400 text-[9px] mt-0.5" style={{ fontFamily: fonts.regular }}>{t("Auto.Common.Weeklyperforman", "Weekly performance summaries & statements")}
        ...
        <View key={sidx} className="mb-6">
              ...
              return (
                ...
                <TouchableOpacity className="bg-rose-50 border border-rose-100 py-3.5 rounded-2xl flex-row items-center justify-center mt-2">
                    ...
                    <Text className="text-rose-700 text-xs font-bold" style={{ fontFamily: fonts.bold }}>{t("Auto.Common.SignOut", "Sign Out")}
