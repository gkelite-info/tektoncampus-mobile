                ...
                <View className="flex-row p-1 gap-2 items-center justify-between w-full mb-2">
                    <View className="flex-1 max-w-5xl mr-2">
                        ...
                        >
                            ...
                            <View className="flex-row items-center">
                                <Text className="text-gray-600 text-[13px] ml-1" style={{ fontFamily: fonts.medium }}>
                                    Year :
                                </Text>
                                <View className="bg-[#43C17A1C] px-2 py-0.5 rounded-full ml-1">
                ...
                >
                    <View className="bg-white rounded-xl shadow-lg w-[260px] border border-gray-200 overflow-hidden">
                        <View className="flex-row items-center justify-between px-4 py-3 border-b border-gray-100">
                            <Text className="text-sm text-gray-800" style={{ fontFamily: fonts.semiBold }}>
                                Previous Sem Marks
                            </Text>
                        ...
                        >
                            <Text className="text-sm text-gray-700" style={{ fontFamily: fonts.regular }}>Enrollment</Text>
                        </TouchableOpacity>
                    </View>
                </TouchableOpacity>
            </Modal>
