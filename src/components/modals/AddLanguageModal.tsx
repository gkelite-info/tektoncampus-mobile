...
export default function AddLanguageModal({ isOpen, onClose, onAdd }: AddModalProps) {
            ...
            <View className="flex-1 bg-black/50 justify-center items-center px-4">
                <View className="bg-white w-full max-w-md rounded-xl p-6 shadow-lg">
                    <View className="flex-row justify-between items-center mb-4">
                        <Text className="text-lg font-medium text-gray-800">Add Language</Text>
                    ...
                    <View className="mb-6">
                        <Text className="text-sm text-gray-600 mb-1">Language name</Text>
                        <TextInput
                            value={value}
