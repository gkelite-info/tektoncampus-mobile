...
import { View, Text, TouchableOpacity, Modal, TextInput, ActivityIndicator, SafeAreaView } from "react-native";
...
export default function AddSkillModal({ isOpen, onClose, onAdd, defaultSection = "Technical Skills", isLoading = false }: AddModalProps) {
            ...
            <View className="flex-1 bg-black/50 justify-center items-center px-4">
                <View className="bg-white w-full max-w-md rounded-xl p-6 shadow-lg">
                    <View className="flex-row justify-between items-center mb-4">
                        <Text className="text-lg font-medium text-gray-800">Add Skill</Text>
                    ...
                    <View className="mb-4">
                        <Text className="text-sm text-gray-600 mb-1">Select section</Text>
                        <TouchableOpacity 
                    ...
                    <View className="mb-6">
                        <Text className="text-sm text-gray-600 mb-1">Skill name</Text>
                        <TextInput
                            value={value}
                    ...
                    <View className="flex-row justify-end gap-3">
                        ...
                        >
                            {isLoading ? (
                                ...
                                <Text className="text-white font-bold">Add Skill</Text>
                            )}
                        </TouchableOpacity>
                    </View>
                </View>
