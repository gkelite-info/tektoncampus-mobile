...
import { View, TouchableOpacity, Modal, FlatList, ActivityIndicator, Platform } from 'react-native';
...
export default function EmailModal({ visible, onClose, initialView }: Props) {const { t } = useTranslation();
  ...
  useEffect(() => {
    if (visible && initialView) {
      ...
      if (initialView.compose) setIsComposeOpen(true);else
