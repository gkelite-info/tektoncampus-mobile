...
export default function FacultyCustomDrawer(props: DrawerContentComponentProps) {
    ...
    return (
        <SafeAreaView className="flex-1 bg-[#47c67b]">
            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
                <DrawerItem
                    label="Home"
                    icon={<House size={24} color={isActive("FacultyTabs") ? "#3fbe73" : "#FFFFFF"} weight={isActive("FacultyTabs") ? "fill" : "regular"} />}
                    isActive={isActive("FacultyTabs")}
                    onPress={() => navigateTo("FacultyTabs")}
                />
                <DrawerItem
                    label="Calendar"
