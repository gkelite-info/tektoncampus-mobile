...
export const StudentPerformanceCard = ({
  ...
  return <View className="bg-white rounded-2xl p-4 shadow-sm w-full mb-4">
        ...
        return <View key={student.id || index} className="flex-row items-center py-2.5 border-b border-gray-50">
                    ...
                    <Text className="flex-1 font-medium text-gray-800 text-xs">{t("Auto.Common.Student", "Student")}
        {index + 1}
                    </Text>
            ...
            <View>
                <View className="flex-row justify-between items-start gap-2">
                    ...
                    {lesson.sessionStatus === "Accepted" && <View className="bg-emerald-100 px-2 py-0.5 rounded-md">
                            <Text className="text-emerald-700 text-[9px] font-bold uppercase tracking-wider">{t("Auto.Common.Accepted", "Accepted")}

          </Text>
                        </View>}
                    {lesson.sessionStatus === "Cancel" && <View className="bg-red-100 px-2 py-0.5 rounded-md">
                            <Text className="text-red-700 text-[9px] font-bold uppercase tracking-wider">{t("Auto.Common.Cancelled", "Cancelled")}
...
export const UpcomingClasses = ({
  ...
  return <View className="bg-white rounded-2xl p-4 shadow-sm w-full mb-4">
            <View className="flex-row items-center justify-between mb-4">
                <Text className="text-[15px] font-bold text-gray-900">{t("Auto.Common.UpcomingClasses", "Upcoming Classes")}
